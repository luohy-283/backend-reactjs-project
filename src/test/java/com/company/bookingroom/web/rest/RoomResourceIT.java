...
import static com.company.bookingroom.domain.RoomAsserts.*;
...
class RoomResourceIT {
    ...
    public static Room createEntity() {
        return new Room().name(DEFAULT_NAME).capacity(DEFAULT_CAPACITY).isActive(DEFAULT_IS_ACTIVE);
    }
    ...
    public static Room createUpdatedEntity() {
        return new Room().name(UPDATED_NAME).capacity(UPDATED_CAPACITY).isActive(UPDATED_IS_ACTIVE);
    }
    ...
    void getAllRooms() throws Exception {
        ...
        restRoomMockMvc
            ...
            .andExpect(jsonPath("$.content.[*].id").value(hasItem(room.getId().intValue())))
            ...
            .andExpect(jsonPath("$.content.[*].isActive").value(hasItem(DEFAULT_IS_ACTIVE)))
    ...
    void putExistingRoom() throws Exception {
        ...
        updatedRoom.name(UPDATED_NAME).capacity(UPDATED_CAPACITY).isActive(UPDATED_IS_ACTIVE);
    ...
    void fullUpdateRoomWithPatch() throws Exception {
        ...
        partialUpdatedRoom.name(UPDATED_NAME).capacity(UPDATED_CAPACITY).isActive(UPDATED_IS_ACTIVE);
